...
public final class GrowingMachine extends AbstractMachine implements RecipeDisplayItem {
    ...
    private static final ItemStack GROWING = new CustomItem(Material.LIME_STAINED_GLASS_PANE, "&a生長中...");
    private static final ItemStack INPUT_PLANT = new CustomItem(Material.BLUE_STAINED_GLASS_PANE, "&9放入植物!");
