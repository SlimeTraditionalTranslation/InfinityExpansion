...
public final class MobDataCard extends SlimefunItem implements RecipeDisplayItem, NotPlaceable {
    ...
    public static void setup(InfinityExpansion plugin) {
        new MobDataCard("殭屍", 60, 1, Material.DIAMOND_CHESTPLATE, new ItemStack[] {
        ...
        new MobDataCard("史萊姆", 90, 1, Material.DIAMOND_CHESTPLATE, new ItemStack[] {
        ...
        new MobDataCard("岩漿立方怪", 120, 2, Material.DIAMOND_CHESTPLATE, new ItemStack[] {
        ...
        new MobDataCard("牛", 30, 1, Material.IRON_CHESTPLATE, new ItemStack[] {
        ...
        new MobDataCard("綿羊", 30, 1, Material.IRON_CHESTPLATE, new ItemStack[] {
        ...
        new MobDataCard("蜘蛛", 90, 1, Material.DIAMOND_CHESTPLATE, new ItemStack[] {
        ...
        new MobDataCard("骷髏", 90, 1, Material.DIAMOND_CHESTPLATE, new ItemStack[] {
        ...
        new MobDataCard("凋零骷髏", 150, 3, Material.DIAMOND_CHESTPLATE, new ItemStack[] {
        ...
        new MobDataCard("終界使者", 240, 5, Material.DIAMOND_CHESTPLATE, new ItemStack[] {
        ...
        new MobDataCard("苦力怕", 120, 2, Material.DIAMOND_CHESTPLATE, new ItemStack[] {
        ...
        new MobDataCard("深海守衛", 240, 2, Material.DIAMOND_CHESTPLATE, new ItemStack[] {
        ...
        new MobDataCard("雞", 60, 1, Material.IRON_CHESTPLATE, new ItemStack[] {
        ...
        new MobDataCard("鐵魔像", 180, 1, Material.DIAMOND_CHESTPLATE, new ItemStack[] {
        ...
        new MobDataCard("烈焰使者", 150, 5, Material.DIAMOND_CHESTPLATE, new ItemStack[] {
        ...
        new MobDataCard("凋零怪", 6000, 60, Material.NETHERITE_CHESTPLATE, new ItemStack[] {
        ...
        new MobDataCard("終界龍", 9000, 150, Material.NETHERITE_CHESTPLATE, new ItemStack[] {
