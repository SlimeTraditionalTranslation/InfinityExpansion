...
public final class MobData {
    ...
    public static final SlimefunItemStack INFUSER = new SlimefunItemStack(
            ...
            "&7向空資料卡注入怪物的物品",
            "",
            LorePreset.energy(INFUSER_ENERGY) + "次使用"
    );
    ...
    public static void setup(InfinityExpansion plugin) {
        ...
        new MobDataCard("殭屍", MobDataTier.HOSTILE, new ItemStack[] {
        ...
        new MobDataCard("史萊姆", MobDataTier.NEUTRAL, new ItemStack[] {
        ...
        new MobDataCard("岩漿立方怪", MobDataTier.NEUTRAL, new ItemStack[] {
        ...
        new MobDataCard("綿羊", MobDataTier.PASSIVE, new ItemStack[] {
        ...
        new MobDataCard("骷髏", MobDataTier.HOSTILE, new ItemStack[] {
        ...
        new MobDataCard("凋零骷髏", MobDataTier.HOSTILE, new ItemStack[] {
        ...
        new MobDataCard("終界使者", MobDataTier.ADVANCED, new ItemStack[] {
        ...
        new MobDataCard("深海守衛", MobDataTier.HOSTILE, new ItemStack[] {
        ...
        new MobDataCard("雞", MobDataTier.PASSIVE, new ItemStack[] {
        ...
        new MobDataCard("鐵魔像", MobDataTier.HOSTILE, new ItemStack[] {
        ...
        new MobDataCard("烈焰使者", MobDataTier.ADVANCED, new ItemStack[] {
        ...
        new MobDataCard("凋零怪", MobDataTier.MINI_BOSS, new ItemStack[] {
        ...
        new MobDataCard("終界龍", MobDataTier.BOSS, new ItemStack[] {
